...
val TrashPilotBackground = Color(0xFFFBFAFD)
val TrashPilotPrimary = Color(0xFF3C3467)
val TrashPilotOnPrimary = Color(0xFFFFFFFF)
val TrashPilotText = Color(0xFF1B1824)
val TrashPilotTextSecondary = Color(0xFF524D5D)
